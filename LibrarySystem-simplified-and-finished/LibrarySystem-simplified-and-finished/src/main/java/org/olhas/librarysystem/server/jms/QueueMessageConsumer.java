...
public class QueueMessageConsumer implements MessageListener {
    ...
    private void handleTextMessage(ActiveMQTextMessage message) throws JMSException, JAXBException {
        ...
        File file = new File("C:\\_Study\\ViKo\\00_WebServices\\LibrarySystem-simplified-and-finished\\LibrarySystem-simplified-and-finished\\src\\main\\resources\\xml\\library_received_from_activemq.xml");
